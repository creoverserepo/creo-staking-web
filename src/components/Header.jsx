...
function Header() {
  ...
  return (
    <header>
        ...
        <nav className="w-full flex-grow hidden lg:flex lg:items-center lg:w-auto">
          ...
          <div className="ml-auto">
            {!walletAddress ? (
              ...
              <button
                className="header-connected-wallet flex items-center"
                onClick={() => open()}
              >
      ...
      <div
        className={"navbar " + (openNavbar ? "visible" : "")}
        onClick={() => setOpenNavbar(!openNavbar)}
      >
        <ul className="header-nav-mobile" onClick={(e) => e.stopPropagation()}>
          ...
          <li>
            <a
              href="https://creoplay.app/marketplace"
              className="header-link"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <li>
            <a
              href="https://creoplay.app/comingsoon"
              className="header-link"
              target="_blank"
              rel="noreferrer"
            >
